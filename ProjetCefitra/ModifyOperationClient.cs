...
{
    public partial class ModifyOperationClient : Form
    {
        OperationClient operation;

        public ModifyOperationClient(OperationClient operation)
        {
            InitializeComponent();
            this.operation = operation;
        }

        private void ModifyOperationClient_Load(object sender, EventArgs e)
        {
        ...
        private void bunifuImageButton1_Click(object sender, EventArgs e)
        {
            ...
            Client client = app.manager.searchClientByKey(bunifuCustomTextbox8.Text)[0];
            ...
            app.manager.updateOperationClient(operation, new OperationClient(code, client, paiement, designation, quantite, prixUnitaire, dateOperation));
            Close();
        }
